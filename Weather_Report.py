...
'''
Step 1: Ask user what city's they're in
Step 2: Use city name to get WOEID
Step 3: Use WOEID to get weather data
Step 4: Convert data from JSON text to Python Dict
Step 5: Loop over the dict and display the forecast for each day
'''
# Basic practice
import requests
...
# humidity for the third day listed in the consolidated weather forecasts
d['consolidated_weather'][2]['humidity']
